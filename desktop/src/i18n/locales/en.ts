export const en = {
  ...
  'slash.addDir.title': 'Add working directory',
  'slash.addDir.subtitle': 'Add a new working directory so the agent can read and edit files across directories.',
  'slash.addDir.pathLabel': 'Directory path',
  'slash.addDir.pathPlaceholder': '/path/to/directory',
  'slash.addDir.browseFolders': 'Browse folders',
  'slash.addDir.browseTree': 'Browse directory tree',
  'slash.addDir.rememberLabel': 'Remember for future sessions',
  'slash.addDir.rememberHint': 'The directory will be saved to local settings and automatically available in future sessions.',
  'slash.addDir.addButton': 'Add directory',
  'slash.addDir.chooseFolder': 'Choose folder',
  'slash.addDir.backToInput': 'Back',
  'slash.addDir.browseError': 'Failed to browse directory.',
  'slash.addDir.noSubdirs': 'No subdirectories',
  'slash.addDir.noSubdirsBody': 'This directory has no subdirectories to browse.',
