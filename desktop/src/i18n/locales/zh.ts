...
export const zh: Record<TranslationKey, string> = {
  ...
  'slash.addDir.title': '添加工作目录',
  'slash.addDir.subtitle': '添加新的工作目录，让 Agent 可以跨目录读取和编辑文件。',
  'slash.addDir.pathLabel': '目录路径',
  'slash.addDir.pathPlaceholder': '/路径/到/目录',
  'slash.addDir.browseFolders': '浏览文件夹',
  'slash.addDir.browseTree': '浏览目录树',
  'slash.addDir.rememberLabel': '记住此目录（后续会话自动可用）',
  'slash.addDir.rememberHint': '该目录将保存到本地设置，在后续会话中自动可用。',
  'slash.addDir.addButton': '添加目录',
  'slash.addDir.chooseFolder': '选择文件夹',
  'slash.addDir.backToInput': '返回',
  'slash.addDir.browseError': '浏览目录失败。',
  'slash.addDir.noSubdirs': '无子目录',
  'slash.addDir.noSubdirsBody': '该目录下没有子目录可供浏览。',
